...
void ComputeCCF::init()
{
  ...
  // memory->create(qnm_r,qmax,2*qmax+1,"ccf:qnm_r");
  // memory->create(qnm_i,qmax,2*qmax+1,"ccf:qnm_i");
...
void ComputeCCF::compute_peratom()
{
  ...
  //       memory->destroy(nearest);
  //       maxneigh = jnum;
  //       memory->create(distsq,maxneigh,"ccf:distsq");
  //       memory->create(rlist,maxneigh,3,"ccf:rlist");
...
void ComputeCCF::select3(int k, int n, double *arr, int *iarr, double **arr3)
{
...
void ComputeCCF::calc_boop(double **rlist,
...
double ComputeCCF::dist(const double r[])
{
...
double ComputeCCF::polar_prefactor(int l, int m, double costheta)
{
...
double ComputeCCF::associated_legendre(int l, int m, double x)
{
  if (l < m) return 0.0;
